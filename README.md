...
Проект по воссозданию блока управления часов на основе перекидных (flip_dot, блинкер) модулей венгерской фирмы Fok_GYEM.

* [Принцип управления](#принцип-управления)
* [Печатные платы](#печатные-платы)
* [Видео](#видео-работы)
* [Кнопочный пульт настройки времени](tm1638.md)

 Внешний вид часов до разборки:
...
Размеры примерно 200х115мм, вес каждого блока около 1.7 кг.
